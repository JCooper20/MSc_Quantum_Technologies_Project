...
def main():
    ...
    ax.set_title(r'REINFORCE training curve — $L=16$, $k=3$')
    ax.legend()
    fig.tight_layout()
    fig.savefig('results/figures/stage6_training_curve_L16_k3.png', dpi=200)
    fig.savefig('results/figures/stage6_training_curve_L16_k3.pdf')
    print("Saved → results/figures/stage6_training_curve_L16_k3.png/.pdf")
